<?php namespace Evolco\SwaggerDocs\Responses\SchemaBuilders;

use Illuminate\Support\Str;
use Evolco\SwaggerDocs\Responses\SchemaBuilder;

/**
 * Class
 * @package Evolco\SwaggerDocs\Responses\SchemaBuilders
 */
