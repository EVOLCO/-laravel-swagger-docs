...
namespace Evolco\SwaggerDocs\Definitions;
 ...
 * @package Evolco\SwaggerDocs\Definitions
 */
class DefinitionGenerator {
                ...
                */
                ...
                foreach ($appends->getValue($obj) as $item) {
                    ...
                    if ( ! $reflection->hasMethod($methodeName)) {
                        Log::warning("[Evolco\SwaggerDocs] Method $model::$methodeName not found while parsing '$item' attribute");
                        continue;
                    }
