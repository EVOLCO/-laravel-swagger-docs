...
use Exception;
use Evolco\SwaggerDocs\Exceptions\InvalidDefinitionException;
use ReflectionClass;
...
use Evolco\SwaggerDocs\Parameters;
use Evolco\SwaggerDocs\DataObjects;
...
use Evolco\SwaggerDocs\Definitions\DefinitionGenerator;
use Evolco\SwaggerDocs\Exceptions\InvalidAuthenticationFlow;
use Evolco\SwaggerDocs\Exceptions\SchemaBuilderNotFound;
...
class Generator {
    ...
    private function generateCustomResponseSchema(string $operation, string $model, string $uri) {
        ...
        try {
            ...
            throw new Exception("SchemaBuilder must implements Evolco\SwaggerDocs\Responses\SchemaBuilder interface");
        }
    }
