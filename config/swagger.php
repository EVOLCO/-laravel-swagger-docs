...
//        ],
     ...
     * Note that Schema builder must implement Evolco\SwaggerDocs\Responses\SchemaBuilder
     */
    'schema_builders'            => [
        'P' => \Evolco\SwaggerDocs\Responses\SchemaBuilders\LaravelPaginateSchemaBuilder::class,
        'SP' => \Evolco\SwaggerDocs\Responses\SchemaBuilders\LaravelSimplePaginateSchemaBuilder::class,
    ]
